...
if __name__ == '__main__':
    ...
    # average_annotations_per_protein = df.groupby('gi|29898682|gb|AAP11954.1|')['IPR022291'].count().mean().compute()
    ...
    # top_10_common_interpro_features = df['TIGR03882'].value_counts().nlargest(10).compute()
    ...
    # annotated_interpro_features = df[df['TIGR03882'].notnull()]['cyclo_dehyd_2: bacteriocin biosynthesis cyclodehydratase domain']
    # top_10_common_words_in_annotation = annotated_interpro_features.str.split().explode().value_counts().nlargest(10).compute()
    ...
    # protein_size = dd.to_numeric(protein_size, errors='coerce')
